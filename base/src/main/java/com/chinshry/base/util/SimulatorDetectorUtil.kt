...
object SimulatorDetectorUtil {
    ...
    private val SYZS_SIMULATOR = SimulatorBean("syzs", "腾讯手游助手")
    private val LDMNQ_SIMULATOR = SimulatorBean("flysilkworm", "雷电")
    private val YESHEN_SIMULATOR = SimulatorBean("bignox", "夜神")
    private val MUMU_SIMULATOR = SimulatorBean("mumu", "MuMu")
    private val HAIMAWAN_SIMULATOR = SimulatorBean("haimawan", "海马玩")
    private val TIANTIAN_SIMULATOR = SimulatorBean("tiantian", "天天")
    private val BLUESTACKS_SIMULATOR = SimulatorBean("bluestacks", "蓝叠")
    private val XYAZ_SIMULATOR = SimulatorBean("microvirt", "逍遥")
